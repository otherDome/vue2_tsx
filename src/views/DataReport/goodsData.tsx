...
import style from '@/assets/styles/DataReport/goodsData.module.scss';
...
export default class goodsData extends Mixins(onresize) {
  //临时变量开始
  ...
  protected render() {
    return <div class={style.goodsData}>
      <div class={[style.goodsData_from, style.goodsData_frommax680]} id='elFromwidth'>
        {
          this.screening === false ? <div class={style.goodsData_from_header}>
            <div class={style.goodsData_from_header_left}>
              <el-form
                size='mini'
                inline={true}
              >
                <el-form-item>
                  <el-input v-model={this.value} size='mini' placeholder="请输入商品名称"></el-input>
                </el-form-item>
                {
                  this.elFromwidth > 690 ? <el-form-item>
                    <el-select
                      filterable
                      v-model={this.value1}
                      placeholder="请选择复购时间">
              ...
              <el-select
                ...
                <el-option label="类别3" value="2"></el-option>
                <el-option label="类别4" value="3"></el-option>
              </el-select>
            </el-form-item> */}
                {
                  this.elFromwidth > 910 ?
                    <el-form-item>
                      <el-date-picker
                        v-model={this.value3}
            ...
            <div class={style.goodsData_from_header_right}>
              <el-button
                icon="el-icon-search"
                size="mini"
                type="primary"
          ...
          </div> : <div class={style.goodsData_from_footer}>
            <div class={style.goodsData_from_footer_top} >
              <div class={style.goodsData_from_footer_top_left}>
                <div class={style.shaixuan}>
                  <icon-filter class={style.icon_filter} theme="outline" size="16" fill="#409EFF" />
                  <span>高级筛选</span>
                </div>
              </div>
              <div class={style.goodsData_from_footer_top_right}>
                <el-button
            ...
            <div class={style.goodsData_from_footer_ft}>
              <el-form
                size='mini'
                inline={true}
              >
      ...
      <div class={[style.goodsData_from, style.goodsData_frommin680]} >
        手机端
      </div>
      <div class={[style.goodsData_table]}>
        <div class={[style.goodsData_table_title]}>
          <el-button class={style.goodsData_table_title_dc} size='mini' type="success" icon='el-icon-download'>导出</el-button>
          <datalistTableTitle
            props={{
