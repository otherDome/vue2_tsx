...
import style from '@/assets/styles/DataReport/Afterpurchase.module.scss';
...
export default class App extends Mixins(onresize) {
  //临时变量
  ...
  protected render() {
    return <div class={style.Afterpurchase}>
      <div class={style.Afterpurchase_from} id="elFromwidth">
        {
          this.screening === false ? <div class={style.Afterpurchase_from_header}>
            <div class={style.Afterpurchase_from_left}>
              <el-form
                size='mini'
                inline={true}
              >
            ...
            <div class={style.Afterpurchase_from_right}>
              <el-button
                icon="el-icon-search"
                size="mini"
                type="primary"
          ...
          </div> : <div class={style.Afterpurchase_from_footer}>
            <div class={style.Afterpurchase_from_footer_top} >
              <div class={style.Afterpurchase_from_footer_top_left}>
                <div class={style.shaixuan}>
                  <icon-filter class={style.icon_filter} theme="outline" size="16" fill="#409EFF" />
                  <span>高级筛选</span>
                </div>
              </div>
              <div class={style.Afterpurchase_from_footer_top_right}>
                <el-button
            ...
            <div class={style.Afterpurchase_from_footer_footer}>
              <el-form
                size='mini'
                inline={true}
              >
                <el-form-item label="请选择复购时间">
                  <el-select
                    filterable
                    v-model={this.isvalue}
                    placeholder="请选择复购时间">
      ...
      <div class={style.Afterpurchase_table}>
        <div class={style.Afterpurchase_table_header}>
          <datalistTableTitle
            props={{
